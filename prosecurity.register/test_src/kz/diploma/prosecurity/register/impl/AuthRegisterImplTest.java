...
//
//import kz.diploma.prosecurity.controller.model.ParentChildList;
...
//    //
//    //
//    ParentChildList parentChildList = authRegister.get().getParentChildList(id);
//    //
//    //
//
//    assertThat(parentChildList).isNotNull();
//    assertThat(parentChildList.fio).isEqualTo(surname + ' ' + name + ' ' + patronymic);
//    assertThat(parentChildList.username).isEqualTo(username);
...
//    //
//    //
//    authRegister.get().getParentChildList(RND.str(10));
//    //
//    //
//  }
//
